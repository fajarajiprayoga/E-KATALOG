      ...
      <div class="col-lg-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h6 class="text-uppercase mb-0 mt-1">Master Type</h6>
                <button class="btn btn-primary btn-sm px-3 rounded btnaddtype"><i class="fas fa-plus"></i> Tambah</button>
            </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="typeModalLabel">Modal title</h5>
      ...
      <div class="modal-footer">
        ...
        <button id="btnsavetype" type="submit" class="btn d-none hiden btn-primary savetype">Simpan</button>
        <button id="btnupdatetype" type="submit" class="btn d-none btn-primary updatemastertype">Simpan</button>
      </div>
    </div>
  </div>
</div>
...
<script type="text/javascript">
    $(document).ready(function() {
      ...
      $('.btnaddtype').on('click', function() {
            $('#typeModalLabel').text('Form tambah type');
            $('#btnsavetype').removeClass('d-none');
