...
$allowed_ext = array("jpg", "jpeg", "pdf", "JPG", "JPEG", "PDF");
...
if(in_array($format[1], $allowed_ext)){
    if($file_size < $maxsize){
        ...
        insertDesign($name_file, $_POST['deskrispi'], $_POST['idchasis'], $_POST['version'], $lastVersion);
...
function insertDesign($name_file, $deskripsi, $idchasis, $version, $lastversion){
    ...
    $command= Yii::app()->dbOracle->createCommand("INSERT INTO KATALOG_DESIGN (FILE_NAME, FILE_DESKRIPSI, FILE_VERSION, ID_CHASIS, ISLASTVERSION, CREATED_AT, CREATED_BY)VALUES(:FILE_NAME, :FILE_DESKRIPSI, :FILE_VERSION, :ID_CHASIS, :ISLASTVERSION ,to_date(:CREATED_AT, 'dd-mm-yy hh24:mi:ss'),:CREATED_BY)");
