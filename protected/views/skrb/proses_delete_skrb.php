...
if(isset($_POST['idskrb'])){
    ...
    $arr = array();
    $qdatakatalog = Yii::app()->dbOracle->createCommand("SELECT * FROM KATALOG_SKRB_$directori WHERE ID_SKRB_$directori = '$idskrb'")->queryAll();
    ...
    if($data['islastversion'] == 'X') {
        ...
        Yii::app()->dbOracle->createCommand("DELETE FROM KATALOG_SKRB_$directori WHERE ID_SKRB_$directori = '$idskrb'")->execute();
