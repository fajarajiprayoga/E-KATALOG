...
function insertSkrb($name_file, $deskripsi, $directori, $idchasis, $version, $lastversion){
    ...
    $command= Yii::app()->dbOracle->createCommand("INSERT INTO KATALOG_SKRB_$directori (FILE_NAME, FILE_DESKRIPSI, FILE_VERSION, ID_CHASIS, ISLASTVERSION, CREATED_AT, CREATED_BY)VALUES(:FILE_NAME, :FILE_DESKRIPSI, :FILE_VERSION, :ID_CHASIS, :ISLASTVERSION ,to_date(:CREATED_AT, 'dd-mm-yy hh24:mi:ss'),:CREATED_BY)");
